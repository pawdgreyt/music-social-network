<template>
    <div id="CreatePost" class="container max-w-4xl mx-auto pt-20 pb-20 px-6">
        <div class="text-gray-900 text-xl">Create Profile</div>
...
const createPost = async () => {
    ...
    if (imageData === null) {
        Swal.fire(
            ...
            "Please cropped an image of your choice",
            "warning"
        );
    ...
    try {
        ...
        await postsStore.fetchPostsByUserId(userStore.id);

        Swal.fire(
            "New post created!",
            "The Post you created was inserted",
            "success"
        );
